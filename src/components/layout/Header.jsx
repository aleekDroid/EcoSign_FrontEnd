import { Menu, MenuButton, MenuList, MenuItem, Button, Icon, Box, Flex, useColorMode, IconButton, Text } from "@chakra-ui/react";
...
function Header() {
  ...
  useEffect(() => {
    const storedName = localStorage.getItem('ecoSign_userName');
    if (storedName) {
  ...
  const logOut = (e) => {
    ...
    localStorage.removeItem('ecoSign_userName');
